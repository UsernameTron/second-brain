...
|---|---|---|
| **Scout** | Web research with sources | "Research what Five9 announced this quarter" |
| **Radar** | Lead scoring and hot-lead lists | "Find me hot leads in healthcare" |
| **Dossier** | One-page account briefs | "Give me a brief on Hunter Douglas" |
| **Qualifier** | Sorting a lead list into A/B/C | "Qualify this list" (attach the file) |
| **Pitch** | Proposal drafts as Google Docs | "Draft a proposal for the Acme renewal" |
| **Wedge** | Competitor battlecards | "Build a battlecard against Telarus" |
| **SDR** | Lead lists → CRM records → opener drafts | "Work this webinar list" |
| **Quill** | LinkedIn posts, articles, emails in CTG's voice | "Turn this brief into a LinkedIn post" |
| **Enrichment** | Filling in contact/company details | "Find contact info for these 10 people" |
