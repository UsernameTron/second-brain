...
# read-only service key (Pete holds it; do NOT mint a new one):
#   printf '%s' "$HUBSPOT_MCP_TOKEN" | gcloud secrets create hubspot-mcp-token \
#     --project agent-canvas-ctg-0811 --data-file=-
set -euo pipefail
