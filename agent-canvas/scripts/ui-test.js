...
const checks = [
  ['journey-test.js'],
  ...['rooms-memory', 'scheduling-builder', 'owner-diagnostics', 'workspace-tools', 'needs-you', 'system-recovery', 'draft-safety', 'home-navigation', 'review-navigation', 'review-clarity']
