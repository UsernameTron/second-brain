...
| 27 | Context Honesty | No surface reinvents what already ships; no status block goes stale unnoticed | SURFACE-REACH-01, REQ-CTX-01 |
...
**Phase 27: Context Honesty** — [SURFACE-REACH-01, REQ-CTX-01]
Success criteria:
...
3. `.planning/research/AUTHORITY.md`'s source-of-truth hierarchy is either adopted or explicitly rejected in writing — the four-competing-sources problem it names is not left unanswered.
