...
npm test      # Jest 30 — 1469 total tests (1430 pass, 39 skipped in CI)
```
...
- **1469 total tests** across 76 test files (1430 passing, 39 skipped in CI)
...
```bash
npm test                    # Run all tests (1469 total; set CI=true to skip UAT)
