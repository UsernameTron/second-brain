...
npm test      # Jest 30 — 1508 total tests (1470 pass, 38 skipped in CI)
```
...
- **1508 total tests** across 80 test files (1470 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1508 total; set CI=true to skip UAT)
