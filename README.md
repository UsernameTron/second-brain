...
npm test      # Jest 30 — 1287 total tests (1249 pass, 38 skipped in CI)
```
...
- **1287 total tests** across 67 test files (1249 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1287 total; set CI=true to skip UAT)
