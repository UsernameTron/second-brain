...
npm test      # Jest 30 — 1559 total tests (1521 pass, 38 skipped in CI)
```
...
test/                         # 1559 tests across 82 files
...
- **1559 total tests** across 82 test files (1521 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1559 total; set CI=true to skip UAT)
