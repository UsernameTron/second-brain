...
npm test      # Jest 30 — 1591 total tests (1553 pass, 38 skipped in CI)
```
...
test/                         # 1591 tests across 84 files
...
- **1591 total tests** across 84 test files (1553 passing, 38 skipped in CI; 1562 passing / 29 skipped locally)
...
```bash
npm test                    # Run all tests (1591 total; set CI=true to skip UAT)
