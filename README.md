...
npm test      # Jest 30 — 1494 total tests (1456 pass, 38 skipped in CI)
```
...
- **1494 total tests** across 79 test files (1456 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1494 total; set CI=true to skip UAT)
