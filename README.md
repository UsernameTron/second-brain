...
npm test      # Jest 30 — 1384 total tests (1346 pass, 38 skipped in CI)
```
...
- **1384 total tests** across 71 test files (1346 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1384 total; set CI=true to skip UAT)
