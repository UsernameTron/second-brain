...
npm test      # Jest 30 — 1456 total tests (1418 pass, 38 skipped in CI)
```
...
- **1456 total tests** across 76 test files (1418 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1456 total; set CI=true to skip UAT)
