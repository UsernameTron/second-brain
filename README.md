...
npm test      # Jest 30 — 1585 total tests (1547 pass, 38 skipped in CI)
```
...
test/                         # 1585 tests across 84 files
...
- **1585 total tests** across 84 test files (1547 passing, 38 skipped in CI; 1556 passing / 29 skipped locally)
...
```bash
npm test                    # Run all tests (1585 total; set CI=true to skip UAT)
