...
npm test      # Jest 30 — 1461 total tests (1422 pass, 39 skipped in CI)
```
...
- **1461 total tests** across 76 test files (1422 passing, 39 skipped in CI)
...
```bash
npm test                    # Run all tests (1461 total; set CI=true to skip UAT)
