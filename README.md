...
npm test      # Jest 30 — 1549 total tests (1511 pass, 38 skipped in CI)
```
...
test/                         # 1549 tests across 82 files
...
- **1549 total tests** across 82 test files (1511 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1549 total; set CI=true to skip UAT)
