...
npm test      # Jest 30 — 1336 total tests (1298 pass, 38 skipped in CI)
```
...
- **1336 total tests** across 70 test files (1298 passing, 38 skipped in CI)
- **Branch coverage:** 81.59% (threshold: ≥80% enforced in CI)
...
```bash
npm test                    # Run all tests (1336 total; set CI=true to skip UAT)
...
Current coverage (CI-measured 2026-07-19): Statements 91.81%, Functions 95.70%, Lines 92.48%, Branch 81.59%
