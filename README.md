...
npm test      # Jest 30 — 1288 total tests (1250 pass, 38 skipped in CI)
```
...
- **1288 total tests** across 67 test files (1250 passing, 38 skipped in CI)
...
```bash
npm test                    # Run all tests (1288 total; set CI=true to skip UAT)
