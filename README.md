...
npm test      # Jest 30 — 1321 total tests (1283 pass, 38 skipped in CI)
```
...
- **1321 total tests** across 69 test files (1283 passing, 38 skipped in CI)
- **Branch coverage:** 81.49% (threshold: ≥80% enforced in CI)
...
```bash
npm test                    # Run all tests (1321 total; set CI=true to skip UAT)
...
Current coverage (CI-measured 2026-07-19): Statements 91.77%, Functions 95.86%, Lines 92.46%, Branch 81.49%
