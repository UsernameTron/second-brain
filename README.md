...
npm test      # Jest 30 — 1468 total tests (1429 pass, 39 skipped in CI)
```
...
- **1468 total tests** across 76 test files (1429 passing, 39 skipped in CI)
...
```bash
npm test                    # Run all tests (1468 total; set CI=true to skip UAT)
